...
const Login = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-10 p-8 bg-white rounded-lg shadow-lg perspective-1000">
      <div className={`transform transition-transform duration-300 ${isSignup ? 'rotate-y-180' : ''}`}>
        {!isSignup && (
